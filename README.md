...
Main features:
- Four lanes: concept, model, Spine, animation
- Drag tasks to adjust start date
- Drag right edge to adjust duration
- Risk highlighting for dependency conflicts
- JSON, CSV, PDF, PNG, and share-page export
